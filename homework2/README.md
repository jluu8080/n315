# Homework 2 — Simple MVC Site

A simple single-page site built with the MVC (Model–View–Controller) structure shown in class.
Four navigation links swap the page content in place without a full page reload.
...
npm run compile:sass   # watch and compile scss/styles.scss -> css/styles.css
```
